...
# Verify SSH connectivity (expected to print a greeting)
ssh -T git@github.com || echo "Note: SSH test non-zero exit code can be normal if GitHub exits after greeting."
